...
import { setFilterSearchSlice, setChildrenReducer, updateSearchText } from 'Components/Hotel/HotelSlice';
...
const Home = ( props ) =>
{
    ...
    const searchHotelHandler = () =>
    {
        ...
        {
            setComponent( <div style={{ color: "red" }}> Search Box Cannot be Empty </div> );
        }
        else
        {
    ...
    return (
        <div style={{ backgroundColor: "dodgerblue", height: "300px", marginTop: "-25px", padding: "20px" }}>
            <div style={{
                padding: "10px",
                marginLeft: "450px",
                ...
                <div style={{ display: "block" }}>
                    ...
                    <br></br>
                    <label>{filterSearch.adults + filterSearch.children} Guest {filterSearch.rooms} Room</label>
                    <div style={{ width: "400px", display: "flex", width: "100%", justifyContent: "space-between", }}>
                    ...
                    }}>
                        {
                            children.map( ( child, index ) =>
                            {
                                return <div style={{ display: "block" }}>
                                    <label htmlFor={index}> <strong>{"Child " + ( index + 1 ) + " Age"}</strong></label>
                                    <br></br>
                                    <div style={{ display: "flex" }}>
                                        ...
                                        <label
                                            style={{
                                                ...
                                                width: "40px",
                                                borderRadius: "10px",
                                            }}><strong>{child.age}</strong></label>
                                        <Button
                                            onClick={() =>
                                            {
                                                setChildren( children.map( item =>
                                                {
                                                    if ( item.id === child.id )
                                                    {
                                                        return {
            ...
            <div className={styles.HotelDiv}>
                {
                    ...
                    {
                        return <Card className={styles.HotelCard} onClick={() =>
                        {
                            setFilterSearch( prevFilter => (
                                {
                                    ...prevFilter,
